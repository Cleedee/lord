...
def test_total_recursos_pos_fase_recursos(
    jogo_com_um_jogador, deck_para_abertura, herois
):
    jogo = jogo_com_um_jogador
    jogo.jogador1.usar_decks(herois, deck_para_abertura)
    jogo.jogador1.embaralhar_deck()
...
def test_existe_cenario(
    jogo_com_um_jogador, deck_para_abertura, deck_de_missao, deck_de_encontro, herois
):
    jogo = jogo_com_um_jogador
...
def test_definir_jogador_inicial_antes_de_comprar_mão_preparação(
    jogo_com_dois_jogadores, herois, deck_para_abertura
):
    jogo = jogo_com_dois_jogadores
    jogo.jogador1.usar_decks(herois, deck_para_abertura)
    jogo.jogador1.comprar_mão_inicial()
...
def test_ler_mao(jogo_com_um_jogador, herois, deck_para_abertura):
    jogo = jogo_com_um_jogador
    jogo.jogador1.usar_decks(herois, deck_para_abertura)
    jogo.jogador1.comprar_mão_inicial()
    assert jogo.jogador1.h2.nome == "Windfola"
